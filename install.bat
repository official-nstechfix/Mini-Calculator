...
set "zipFile=Mini Calculator.zip"
set "extractPath=Mini Calculator"
...
start "" "%cd%\Mini Calculator\instructions.html"

REM Notify the user
echo The ZIP file has been extracted. Please follow the instructions in the opened HTML file to install the Mini Calculator.
